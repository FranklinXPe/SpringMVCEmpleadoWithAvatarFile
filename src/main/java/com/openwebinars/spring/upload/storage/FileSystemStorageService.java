...
public class FileSystemStorageService implements StorageService{
    ...
    public FileSystemStorageService(StorageProperties properties) {
    	// Autoinyeccion de la clase de properties ver: StorageProperties.java en este mismo paquete
     ...
     * 
     * 
     * SE INVOCARA AL ARRANCAR EL PROYECTO, OSEA CADA VEZ QUE ARRANCA EL PROYECTO SE ELIMINAN LAS IMAGENES 
     * YA QUE LOS DATOS ESTAN SIENDO CARGADOS EN MEMORIA
     */
    @Override
